(function (factory) {
    ...
    function _flatten(_this, recursive = false) {
        let array = [];
            ...
            "eval": [
                {
                    ...
                    "return": "any",
                    "js": (exp, context) => {
                        var { expression: expression } = parser_1.Parser.parse(exp);
                        if (expression) {
            ...
            "sub_string": [
                {
                    ...
                    "js": (_this, start, length) => _this.substr(start, length)
                }
            ],
            "replace": [
                {
                    ...
                    "return": "NSString*",
                    "js": (_this, target, replacement) => _this.replace(new RegExp(target, "mg"), replacement)
                }
            ],
            "substring": [
                {
                    ...
                    "return": "NSString*",
                    "js": (_this, start) => _this.substr(start)
                },
                {
            ...
            "split": [
                {
                    ...
                    "return": "NSArray*",
                    "js": (_this, separator) => _this.split(separator)
                }
            ],
            "replace_with": [
                {
            ...
            "find": [
                {
                    ...
                    "return": "NSInteger",
                    "js": (_this, str) => _this.indexOf(str)
                }
            ]
        },
        "NSDate": {
            ...
            "last": [
                {
                    ...
                    "return": "id",
                    "js": (_this) => _this.length > 0 ? _this[_this.length - 1] : null
                },
                {
            ...
            "indexOf": [
                {
                    ...
                    "return": "NSInteger",
                    "js": (_this, obj) => _this.indexOf(obj)
                }
            ],
            "join": [
                {
            ...
            "join_property": [
                {
                    ...
                    "js": (_this, str, property) => _this.map(o => o[property]).join(str)
                }
            ],
            "filter": [
                {
            ...
            "concat": [
                {
                    ...
                    "return": "NSArray*",
                    "js": (_this, array) => _this.concat(array)
                }
            ],
            "slice": [
                {
            ...
            "sub_array": [
                {
                    ...
                    "js": (_this, start, length) => _this.slice(start, start + length)
                }
            ],
            "splice": [
                {
                    ...
                    "return": "NSArray*",
                    "js": (_this, start, deleteCount, insertValue) => {
            ...
            "lastIndexOf": [
                {
                    ...
                    "return": "NSInteger",
                    "js": (_this, obj) => _this.lastIndexOf(obj)
                }
            ],
            "flatten": [
                {
            ...
            "firstIndex": [
                {
                    ...
                    "return": "NSInteger",
                    "js": (_this, cb) => _this.findIndex(cb)
                }
            ],
            "any": [
                {
            ...
            "first": [
                {
                    ...
                    "return": "id",
                    "js": (_this) => _this.length > 0 ? _this[0] : null
                },
                {
