...
(function (TokenType) {
    ...
    TokenType[TokenType["NotEqual"] = 14] = "NotEqual";
    TokenType[TokenType["GreaterThan"] = 15] = "GreaterThan";
    TokenType[TokenType["LessThan"] = 16] = "LessThan";
    TokenType[TokenType["GreaterOrEqual"] = 17] = "GreaterOrEqual";
    TokenType[TokenType["LessOrEqual"] = 18] = "LessOrEqual";
    TokenType[TokenType["Not"] = 19] = "Not";
    // punctuations
    ...
    TokenType[TokenType["CloseBracket"] = 24] = "CloseBracket";
    TokenType[TokenType["CloseBrace"] = 25] = "CloseBrace";
    TokenType[TokenType["Dot"] = 26] = "Dot";
    TokenType[TokenType["Question"] = 27] = "Question";
    TokenType[TokenType["Colon"] = 28] = "Colon";
    TokenType[TokenType["Comma"] = 29] = "Comma";
    TokenType[TokenType["Unknown"] = 30] = "Unknown";
            ...
            switch (c) {
                ...
                default:
                    if (this.c === CharCode._ || this.c === CharCode.$ || isalpha(this.c)) {
                        ...
                        do {
                            this._nextChar();
                            if (!(this.c === CharCode._ || this.c === CharCode.$ || isalnum(this.c))) {
                                break;
                            }
                        } while (this.c);
